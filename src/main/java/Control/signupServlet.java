...
public class signupServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sn = request.getParameter("namsinh");
           
            signupDAO dao = new signupDAO();
            Account a = dao.checkExist(user);
            if (a == null) {
                dao.signup(fullname,phone,email,user, pass, gt, sn);
                response.sendRedirect("redirect.jsp");
            } else {
                request.setAttribute("mess", "Account already exists");
                request.getRequestDispatcher("Views/SignupBookStore.jsp").forward(request, response);
            }
